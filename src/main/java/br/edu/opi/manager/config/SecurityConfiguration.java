...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable()
				...
				.antMatchers(HttpMethod.GET, RestConstants.OPI_GRAPH_URI + "/**").permitAll()
				.antMatchers(HttpMethod.GET, RestConstants.OPI_INTERNATIONAL_CHAMPIONS_URI + "/**").permitAll()
				.antMatchers(HttpMethod.GET, RestConstants.OPI_DATES_URI + "/**").permitAll()
				.antMatchers(HttpMethod.PUT, RestConstants.OPI_DATES_URI + "/**").permitAll()
