package br.edu.opi.manager.user.controllers;

import br.edu.opi.manager.project_patterns.dtos.AppControllerBase;
import br.edu.opi.manager.security.SecurityUtils;
import br.edu.opi.manager.security.dtos.PasswordInput;
import br.edu.opi.manager.user.dtos.UserIO;
import br.edu.opi.manager.user.dtos.UserInput;
import br.edu.opi.manager.user.dtos.UserOutput;
import br.edu.opi.manager.user.dtos.UserProfileInput;
import br.edu.opi.manager.user.services.UserService;
import br.edu.opi.manager.utils.RestConstants;
import br.edu.opi.manager.project_patterns.models.user.Privilege;
import br.edu.opi.manager.security.dtos.AccountCredentials;
