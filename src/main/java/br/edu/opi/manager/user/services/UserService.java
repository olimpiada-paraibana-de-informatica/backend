package br.edu.opi.manager.user.services;
...
import br.edu.opi.manager.security.exceptions.SamePasswordRuntimeException;
...
//		blackListService.blockUser(username);
	...
	public UserModel update(Long id, UserModel model) {
		...
		try {
			...
			//UserModel userDB = repositories.save(models);
